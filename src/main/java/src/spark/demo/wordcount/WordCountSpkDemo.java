...
spark-submit  --class src.spark.demo.wordcount.WordCountSpkDemo 
--executor-memory 500m --total-executor-cores 2 
/home/clouder/jar/hadoop-demo-0.0.1-SNAPSHOT.jar 
hdfs://192.168.0.108:9000/user/xink/README.txt
*/
public class WordCountSpkDemo {
    ...
    public static void main(String[] args) throws Exception {
         ...
         */
        SparkConf sparkConf = new SparkConf().setAppName("WordCountSpkDemo");
